...
import { Container, Header, Body, Title, Content, List, ListItem, Left, Right, Icon, Button, Tab, Tabs } from 'native-base';

import Modal from '../components/modal';
import DataItem from '../components/list_item';
import { getArticles } from '../services/technology';


export class Technology extends PureComponent {
        ...
        return (
            <Container>
                <Header>
                    ...
                    <Body>
                        <Title children="What's New Technology" />
                    </Body>
                </Header>
